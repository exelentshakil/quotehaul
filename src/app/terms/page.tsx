    ...
    <>
      ...
      <main className="mx-auto max-w-2xl px-6 py-16">
        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <p><strong className="text-foreground">Billing:</strong> Pro plan subscriptions include a free trial; your card is charged automatically when the trial ends unless you cancel first. You can cancel or manage billing any time from Settings.</p>
